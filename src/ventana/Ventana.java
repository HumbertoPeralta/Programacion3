...
public class Ventana extends JFrame{
	...
	public void componentes() {
		...
		login.setBackground(new Color(20, 155, 232));
		...
		*/
		...
		acceder.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(correo_ingreso.getText().length()<=0) {
					correo_ingreso.setBorder(new LineBorder(Color.RED,4));
				}else {
					correo_ingreso.setBorder(new LineBorder(Color.GREEN,4));
				}
				
				String pwd= new String(contrasena_ingreso.getPassword());
				
				if(pwd.length()<=0) {
					contrasena_ingreso.setBorder(new LineBorder(Color.RED,4));
				}else {
					contrasena_ingreso.setBorder(new LineBorder(Color.GREEN,4));
				}
		...
		registrar.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(nombre.getText().length()<=0) {
					nombre.setBorder(new LineBorder(Color.RED,4));
				}else {
					nombre.setBorder(new LineBorder(Color.GREEN,4));
				}
				
				String pwd= new String(contrasena_registro.getPassword());
				
				if(pwd.length()<=0) {
					contrasena_registro.setBorder(new LineBorder(Color.RED,4));
				}else {
					contrasena_registro.setBorder(new LineBorder(Color.GREEN,4));
				}
				
				if(correo_registro.getText().length()<=0) {
					correo_registro.setBorder(new LineBorder(Color.RED,4));
				}else {
					correo_registro.setBorder(new LineBorder(Color.GREEN,4));
				}
				
				if(masculino.isSelected()==false) {
					masculino.setBorder(new LineBorder(Color.RED,4));
					masculino.setBorderPainted(true);

				}else {
					masculino.setBorder(new LineBorder(Color.GREEN,4));
					masculino.setBorderPainted(true);

				}
				
				if(femenino.isSelected()==false) {
					femenino.setBorder(new LineBorder(Color.RED,4));
					femenino.setBorderPainted(true);
				}else {
					femenino.setBorder(new LineBorder(Color.GREEN,4));
					femenino.setBorderPainted(true);

				}
				if(edad1.isSelected()==false) {
					edad1.setBorder(new LineBorder(Color.RED,4));
					edad1.setBorderPainted(true);

				}else {
					edad1.setBorder(new LineBorder(Color.GREEN,4));
					edad1.setBorderPainted(true);
					
				}
				
				if(edad2.isSelected()==false) {
					edad2.setBorder(new LineBorder(Color.RED,4));
					edad2.setBorderPainted(true);

				}else {
					edad2.setBorder(new LineBorder(Color.GREEN,4));
					edad2.setBorderPainted(true);

				}
				if(edad3.isSelected()==false) {
					edad3.setBorder(new LineBorder(Color.RED,4));
					edad3.setBorderPainted(true);

				}else {
					edad3.setBorder(new LineBorder(Color.GREEN,4));
					edad3.setBorderPainted(true);

				}
				if(edad4.isSelected()==false) {
					edad4.setBorder(new LineBorder(Color.RED,4));
					edad4.setBorderPainted(true);

				}else {
					edad4.setBorder(new LineBorder(Color.GREEN,4));
					edad4.setBorderPainted(true);
	...
	public void paint(Graphics g) {
		...
		g2d.drawArc(10, 10, 100, 100, 50, 50);
		g2d.drawLine(0, 0, 500, 500);
		g2d.setColor(Color.magenta);
		g2d.fillRect(10, 300,200,200);
		g2d.setColor(Color.cyan);
		g2d.fillRect(300, 50, 400, 200);
